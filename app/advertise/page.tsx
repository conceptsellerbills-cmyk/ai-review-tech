...
export const metadata: Metadata = { title: "Advertise — AI Review", description: "Advertise with AI Review and reach a targeted audience interested in AI tools and technology." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on AI Review</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing AI tools and technology. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@ai-review.tech">hello@ai-review.tech</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
