...
export const metadata: Metadata = { title: "Contact — AI Review", description: "Get in touch with the AI Review team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@ai-review.tech">hello@ai-review.tech</a>. We reply within 1–2 business days.</p>
        </div>
