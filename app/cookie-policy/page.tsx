...
export const metadata: Metadata = { title: "Cookie Policy — AI Review", description: "Cookie Policy for AI Review (ai-review.tech)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@ai-review.tech">hello@ai-review.tech</a>.</p>
      </div>
    </>
  );
}
