...
export const metadata: Metadata = { title: "Write for Us — AI Review", description: "Contribute a guest post to AI Review. Share your expertise on AI tools and technology." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know AI tools and technology well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on AI tools and technology</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@ai-review.tech">hello@ai-review.tech</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
