...
export const metadata: Metadata = {
  ...
  description: "Independent, in-depth reviews of 200+ AI tools for writing, coding, images and more. No sponsorships. Just honest expert analysis.",
};
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
          ...
          --accent: #4f8bff; --accent2: #7c5cfc; --radius: 12px;
        }
        body { background: var(--bg); color: var(--text); font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; line-height: 1.6; }
        a { text-decoration: none; color: inherit; }
        .container { max-width: 1100px; margin: 0 auto; padding: 0 24px; }
        .hero { position: relative; overflow: hidden; padding: 90px 24px 80px; text-align: center; }
        .hero::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(79,139,255,0.15) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(124,92,252,0.1) 0%, transparent 60%); pointer-events: none; }
        .hero-badge { display: inline-flex; align-items: center; gap: 8px; padding: 6px 16px; border-radius: 20px; background: rgba(79,139,255,0.1); border: 1px solid rgba(79,139,255,0.25); color: var(--accent); font-size: 0.8rem; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; margin-bottom: 24px; }
        ...
        .hero-cta { display: inline-flex; align-items: center; gap: 8px; padding: 14px 32px; border-radius: 50px; background: linear-gradient(135deg, var(--accent), var(--accent2)); color: #fff; font-weight: 700; font-size: 1rem; transition: opacity 0.2s, transform 0.2s; box-shadow: 0 0 30px rgba(79,139,255,0.3); }
        ...
        .category-card:hover { border-color: var(--accent); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(79,139,255,0.1); }
        ...
        .featured-visual { display: flex; align-items: center; justify-content: center; min-height: 280px; font-size: 5rem; background: linear-gradient(135deg, rgba(79,139,255,0.12), rgba(124,92,252,0.08)); }
        .featured-content { padding: 40px 36px; display: flex; flex-direction: column; justify-content: center; gap: 0; }
        .featured-badge { display: inline-block; padding: 4px 12px; border-radius: 20px; background: rgba(79,139,255,0.12); border: 1px solid rgba(79,139,255,0.25); color: var(--accent); font-size: 0.72rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; margin-bottom: 16px; width: fit-content; }
        ...
        .post-tag { display: inline-block; padding: 3px 10px; border-radius: 20px; background: rgba(124,92,252,0.1); border: 1px solid rgba(124,92,252,0.2); color: var(--accent2); font-size: 0.7rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; margin-bottom: 12px; }
        ...
        .cta-section { margin: 20px 0 60px; padding: 60px 40px; background: linear-gradient(135deg, var(--surface), rgba(79,139,255,0.06)); border: 1px solid var(--border); border-radius: var(--radius); text-align: center; }
...
`}</style>
      ...
      <section className="hero">
        ...
        <p>Expert-tested reviews and head-to-head comparisons of 200+ AI tools. Cut through the hype and find what actually works.</p>
        <a href="/best-ai-tools" className="hero-cta">Browse All Reviews →</a>
        <div className="stats-bar">
          {([{"v":"200+","l":"Tools Reviewed"},{"v":"50K+","l":"Monthly Readers"},{"v":"100%","l":"Independent"},{"v":"2025","l":"Up-to-date"}] as {v:string,l:string}[]).map((s) => (
      ...
      <div className="container">
        ...
        <div className="cta-section">
          ...
          <p>Get the latest AI tool reviews, honest comparisons and expert guides.</p>
