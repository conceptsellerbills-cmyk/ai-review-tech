...
export const metadata: Metadata = { title: "Privacy Policy — AI Review", description: "Privacy Policy for AI Review (ai-review.tech)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p>Welcome to AI Review ("we", "us", or "our"), accessible at ai-review.tech. This Privacy Policy explains how we collect, use, and protect your information when you visit our website.</p>
        ...
        <h2>6. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:hello@ai-review.tech">hello@ai-review.tech</a>.</p>
        ...
        <h2>9. Contact</h2>
        <p>For privacy-related questions, contact us at <a href="mailto:hello@ai-review.tech">hello@ai-review.tech</a>.</p>
      </div>
    </>
  );
}
