...
export function Comments({ title }: CommentsProps) {
  ...
  useEffect(() => {
    ...
    script.setAttribute("data-repo", "conceptsellerbills-cmyk/ai-review-tech");
    script.setAttribute("data-repo-id", "R_kgDOR8_5FQ");
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "DIC_kwDOR8_5Fc4C6gau");
