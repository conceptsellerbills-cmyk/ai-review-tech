...
export function Comments({ slug }: { slug: string; title?: string }) {
  ...
  async function submitComment(e: React.FormEvent) {
    ...
    try {
      ...
      if (!r.ok) { setError("Failed to post comment. Please try again.") }
    ...
    <>
      ...
      <div className="comments-section">
        ...
        <form onSubmit={submitComment} className="comment-form">
          ...
          <button type="submit" disabled={submitting} className="comment-submit">{submitting ? "Posting..." : "Post Comment"}</button>
        </form>
      </div>
    </>
  )
